...
DELETE: pra listas, dicionários e variáveis
Em listas: deleta o item em uma posição específica (índice).
Em dicionários: deleta uma chave específica com sua respectiva entrada.
Em variáveis: remove a variável inteira da memória.
...
CASO CONTRÁRIO, dá erro tentar excluir ambas as chaves, pq NÃO são 
uma Tupla (('Sloth', 'Bengal Tiger'))
"""

zoo_animals['Rockhopper Penguin'] = 'Antartida' # novo valor pra chave
